...
export type { CappedResaleTicket } from "./contracts/CappedResaleTicket";
export { CappedResaleTicket__factory } from "./factories/contracts/CappedResaleTicket__factory";
